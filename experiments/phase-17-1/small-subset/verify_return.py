...
from ss_common import read, record, require, safe, sha, verify, write
from ss_evidence import summarize, verify_execution, verify_training
...
def review(archive, receipt, handoff, destination, completed, guardian):
    ...
    require(
        0 <= terminal["total_elapsed_seconds"] <= outer["total_wall_seconds"] <= 2700,
