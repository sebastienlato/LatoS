...
from ss_common import read, record, require, verify, write
...
def package(cache, output):
    ...
    sources.update(
        {
            ...
            "PROPOSAL.md": "experiments/phase-17-1/SMALL_SUBSET_PROPOSAL.md",
            "LICENSE": "LICENSE",
        }
    )
    ...
    launcher = output.with_name("small-subset-launch.py")
