...
with replacement characters. Float32 CPU and local MPS paths are tested. The owner
reports real Windows/RTX 4070 SUPER CUDA validation on v0.4.2; see
[closure evidence](../experiments/phase-3/CLOSURE.md) for its exact scope. Independent
physical Linux testing is deferred; GitHub Linux CPU CI is separate evidence.
